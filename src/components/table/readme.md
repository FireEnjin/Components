...
| ------------------- | --------------------- | ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------ |
| `columns`           | --                    |             | `{ label?: string; name?: string; key?: string; placeholder?: string; disabled?: boolean; type?: "string" \| "number" \| "boolean" \| "file" \| "phone" \| "tel" \| "select" \| "photo"; options?: any; }[]` | `undefined`                                                        |
