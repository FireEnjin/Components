...
| `nextButton`           | --                       | The next button for the slider                                         | `{ expand?: "block" \| "full"; label?: string; color?: Color; fill?: "default" \| "clear" \| "outline" \| "solid"; icon?: string; iconSlot?: string; onClick?: (event: any) => void; disabled?: boolean; shape?: "round"; size?: "small" \| "default" \| "large"; }` | `{     label: "Next",     color: "primary",     fill: "clear",     icon: "chevron-forward-circle-outline",   }` |
| `pager`                | `pager`                  |                                                                        | `boolean`                                                                                                                                                                                                                                                            | `false`                                                                                                         |
| `prevButton`           | --                       | The prev button for the slider                                         | `{ expand?: "block" \| "full"; label?: string; color?: Color; fill?: "default" \| "clear" \| "outline" \| "solid"; icon?: string; iconSlot?: string; onClick?: (event: any) => void; disabled?: boolean; shape?: "round"; size?: "small" \| "default" \| "large"; }` | `{     label: "Back",     color: "medium",     fill: "clear",     icon: "chevron-back-circle-outline",   }`     |
| `saveButton`           | --                       | The save button for the flow                                           | `{ expand?: "block" \| "full"; label?: string; color?: Color; fill?: "default" \| "clear" \| "outline" \| "solid"; icon?: string; iconSlot?: string; onClick?: (event: any) => void; disabled?: boolean; shape?: "round"; size?: "small" \| "default" \| "large"; }` | `{     label: "Save",     fill: "solid",     color: "primary",   }`                                             |
