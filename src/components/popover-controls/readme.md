...
| `closeOnClear`  | `close-on-clear`  | Should the popover close on clear?                              | `boolean`                     | `true`      |
| `closeOnSelect` | `close-on-select` | Should the popover close on selection?                          | `boolean`                     | `false`     |
